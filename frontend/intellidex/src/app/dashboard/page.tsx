export default function Dashboard() {
  return (
    <div className="bg-[#A4DEEC] w-screen h-screen">
      <div className="grid grid-cols-12 grid-rows-12 w-full h-full">
        <DashboardSidebar />
        <div className="col-start-2 col-end-10 row-start-1 row-end-13 font-[Poppins] py-9 text-black">
          <div className="flex">
            <p className="text-5xl font-semibold">Good Morning, Hitesh!</p>
          </div>
        </div>
      </div>
    </div>
